        ...
        <div class="master">
            <div class="box">
                ...
                <ul class="step">
                    ...
                    <li class="step__item {{ isActive('LaravelSetup::final') }}">
                        <i class="step__icon fa fa-server" aria-hidden="true"></i>
                    </li>
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('LaravelSetup::environment')}} {{ isActive('LaravelSetup::environmentWizard')}} {{ isActive('LaravelSetup::environmentClassic')}}">
                        @if(Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
                            <a href="{{ route('LaravelSetup::environment') }}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('LaravelSetup::permissions') }}">
                        @if(Request::is('install/permissions') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
                            <a href="{{ route('LaravelSetup::permissions') }}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('LaravelSetup::requirements') }}">
                        @if(Request::is('install') || Request::is('install/requirements') || Request::is('install/permissions') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
                            <a href="{{ route('LaravelSetup::requirements') }}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('LaravelSetup::welcome') }}">
                        @if(Request::is('install') || Request::is('install/requirements') || Request::is('install/permissions') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
                            <a href="{{ route('LaravelSetup::welcome') }}">
